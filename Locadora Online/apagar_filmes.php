...
<div align="right"><font color="#727292"> <br>
              ...
              <tr>
                <td align="left" valign="top" height="500" bgcolor="#FFFFFF" class="linkA"><div align="center">
                  <form name="form1" method="post" action="apagar_filmes2.php">
                    <table width="60%" border="0" class="LinkA">
                      ...
                      <tr>
                        ...
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><? echo $registros[1]?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td width="23%"><div align="right">Max&iacute;mo de Dias Emprestado:</div></td>
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><? echo $registros[4]?></td>
                      </tr>
                      <tr>
                        <td colspan="3"><label>
                          <br>
