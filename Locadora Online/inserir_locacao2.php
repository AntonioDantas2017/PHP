...
$resultado=mysql_query($sql) or die ("Conexão Impossível 1");
...
{
	echo "Data devolução não permitida!";
	$erro = 1;
}
*/
...
echo $sql;
$resultado=mysql_query($sql) or die ("Conexão Impossível 2");
echo "Locação feita com sucesso!<br>";
}
