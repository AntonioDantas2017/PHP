...
<div align="right"><font color="#727292"> <br>
              ...
              <tr>
                <td align="left" valign="top" height="500" bgcolor="#FFFFFF" class="linkA"><div align="center">
                  <form name="form1" method="post" action="inserir_clientes2.php">
                    <table width="60%" border="0" class="LinkA">
                      ...
                      <tr>
                        ...
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txtcpf" type="text" id="txtcpf" size="20" maxlength="15"></td>
                      </tr>
                      <tr>
                        <td width="23%"><div align="right">RG:</div></td>
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txtrg" type="text" id="txtrg" size="20" maxlength="15"></td>
                      </tr>
                      <tr>
                        <td width="23%"><div align="right">Telefone:</div></td>
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txttelefone" type="text" id="txttelefone" size="20" maxlength="15"></td>
                      </tr>
                      <tr>
                        <td colspan="3"><label>
                            <div align="center">
