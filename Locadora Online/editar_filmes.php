...
$sql="select * from filmes where codfil = $codfil";
...
<div align="right"><font color="#727292"> <br>
              ...
              <tr>
                <td align="left" valign="top" height="500" bgcolor="#FFFFFF" class="linkA"><div align="center">
                  <form name="form1" method="post" action="editar_filmes2.php">
                    <table width="60%" border="0" class="LinkA">
                      ...
                      <tr>
                        ...
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txtnome" type="text" id="txtnome" value="<? echo $registros[1]?>" size="30" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td width="23%"><div align="right">G&ecirc;nero:</div></td>
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txtgenero" type="text" id="txtgenero" value="<? echo $registros[2]?>" size="20" maxlength="15"></td>
                      </tr>
                      <tr>
                        <td width="23%"><div align="right">Caminho da Foto:</div></td>
                        <td width="2%">&nbsp;</td>
                        <td width="35%"><input name="txtfoto" type="text" id="txtfoto" value="<? echo $registros[4]?>" size="30" maxlength="200"></td>
                      </tr>
                      <tr>
                        <td colspan="3"><label>
                            <div align="center">
